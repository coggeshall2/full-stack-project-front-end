...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://quiet-sands-39548.herokuapp.com/',
...
var onTrailsIndex = function onTrailsIndex(event) {
...
var onGetTrail = function onGetTrail(event) {
  event.preventDefault();
  ...
  if (data.trail.id === '') {
    ...
    api.getTrail(data).then(ui.onGetSuccess).catch(ui.onError);
  }
};

var onDestroyTrail = function onDestroyTrail(event) {
  event.preventDefault();
  ...
  if (data.trail.id === '') {
    ...
    api.destroyTrail(data).then(ui.onDestroySuccess).catch(ui.onError);
  }
};
...
var onUpdateTrail = function onUpdateTrail(event) {
  ...
  if (data.trail.id === '') {
    ...
    api.updateTrail(data).then(ui.onUpdateSuccess).catch(ui.onError);
  }
};

var onCreateTrail = function onCreateTrail(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  // input validation
  if (data.trail.trail_name === '') {
    ...
    api.createTrail(data).then(ui.onCreateSuccess).catch(ui.onError);
  }
};

module.exports = {
  onTrailsIndex: onTrailsIndex,
  onGetTrail: onGetTrail,
  onDestroyTrail: onDestroyTrail,
  onUpdateTrail: onUpdateTrail,
  onCreateTrail: onCreateTrail
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var getTrail = function getTrail(data) {
...
var destroyTrail = function destroyTrail(data) {
  console.log('data is ', data);
  console.log(store);
...
module.exports = {
  trailsIndex: trailsIndex,
  getTrail: getTrail,
  destroyTrail: destroyTrail,
